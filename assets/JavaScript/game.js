var fightOrSkip = function () {
  ...
  // change prompt to lower case to ensure functionality
  promptFight.toLowerCase();

  // Conditional Recursive Function Call
  if (!promptFight) {
    window.alert("You need to provide a valed answer! Please Try Again,");
    return fightOrSkip();
  }
...
var highScore = function(){
  ...
  //if high score is not available, set to 0
  score = score || 0;

  if (playerInfo.money > score){
    //if player sets new high score, alert player of high score and save new high score.
    window.alert("You set a new high score!");
    localStorage.setItem("Score", playerInfo.money.toString);
  }
  else{
    //if not, alert that they did not set new high score.
    window.alert("Sorry, you did not set a new high score.");
  }
}
